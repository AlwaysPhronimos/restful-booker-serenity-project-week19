...
import com.restful.booker.studentinfo.AuthSteps;
...
public class BookingCRUDTestWithSteps extends TestBase {
    ...
    static String firstName = TestUtils.getRandomValue() + "Smart";
    static String lastname = TestUtils.getRandomValue() + "Tester";
